...
export { default as ModalConfirm } from '@/components/old/ModalConfirm.vue';
export { default as ModalPopup } from '@/components/old/ModalPopup.vue';
export { default as DynamicFormRenderer } from '@/components/old/DynamicFormRenderer.vue';
export { default as ModalPrompt } from '@/components/old/ModalPrompt.vue';
export { default as DynamicForm } from '@/components/old/DynamicForm.vue';
